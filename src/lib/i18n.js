...
const LANG_STORAGE = 'khatra_language'
...
const STRINGS = {
  ...
  app_subtitle: { en: 'AI Safety Simulator', hi: 'एआई सेफ्टी सिम्युलेटर', bn: 'এআই সেফটি সিমুলেটর', or: 'AI ସୁରକ୍ଷା ସିମୁଲେଟର', ur: 'اے آئی سیفٹی سمیولیٹر', sat: 'AI Safety Simulator' },
  ...
  home_desc: {
    en: 'KHATRA trains workers to recognize hazards before they become accidents — using a phone camera and an AI safety inspector, no headset or classroom required.',
    hi: 'खतरा (KHATRA) श्रमिकों को दुर्घटना होने से पहले खतरों को पहचानना सिखाता है — फोन कैमरे और एआई सेफ्टी इंस्पेक्टर की मदद से, बिना किसी हेडसेट या क्लासरूम के।',
    bn: 'খতরা শ্রমিকদের দুর্ঘটনা ঘটার আগেই বিপদ চিনতে প্রশিক্ষণ দেয় — ফোনের ক্যামেরা এবং একটি এআই সেফটি ইন্সপেক্টর ব্যবহার করে, কোনো হেডসেট বা ক্লাসরুমের প্রয়োজন নেই।',
    or: 'KHATRA ଶ୍ରମିକମାନଙ୍କୁ ଦୁର୍ଘଟଣା ହେବା ପୂର୍ବରୁ ବିପଦ ଚିହ୍ନଟ କରିବାକୁ ତାଲିମ ଦିଏ — ଫୋନ କ୍ୟାମେରା ଏବଂ ଏକ AI ସୁରକ୍ଷା ନିରୀକ୍ଷକ ବ୍ୟବହାର କରି, କୌଣସି ହେଡସେଟ କିମ୍ବା କ୍ଲାସରୁମ ଦରକାର ନାହିଁ।',
    ur: 'کھترا ورکرز کو حادثہ ہونے سے پہلے خطرات پہچاننا سکھاتا ہے — فون کیمرہ اور ایک اے آئی سیفٹی انسپکٹر کے ذریعے، کسی ہیڈسیٹ یا کلاس روم کی ضرورت نہیں۔',
  },
  ...
  sc_score_label: { en: 'Safety score:', hi: 'सुरक्षा स्कोर:', bn: 'নিরাপত্তা স্কোর:', or: 'ସୁରକ୍ଷା ସ୍କୋର:', ur: 'حفاظتی اسکور:' },
  sc_score_of: { en: 'of decisions matched safe practice.', hi: 'निर्णय सुरक्षित अभ्यास से मेल खाते हैं।', bn: 'সিদ্ধান্ত নিরাপদ অনুশীলনের সাথে মিলেছে।', or: 'ନିଷ୍ପତ୍ତି ସୁରକ୍ଷିତ ଅଭ୍ୟାସ ସହିତ ମେଳ ଖାଇଛି।', ur: 'فیصلے محفوظ طریقہ کار سے مماثل ہیں۔' },
  ...
  dash_title: { en: 'Your Safety Record', hi: 'आपका सुरक्षा रिकॉर्ड', bn: 'আপনার নিরাপত্তা রেকর্ড', or: 'ଆପଣଙ୍କ ସୁରକ୍ଷା ରେକର୍ଡ', ur: 'آپ کا حفاظتی ریکارڈ' },
  dash_sessions: { en: 'Sessions', hi: 'सत्र', bn: 'সেশন', or: 'ସେସନ', ur: 'سیشنز' },
  dash_scans: { en: 'Hazard Scans', hi: 'खतरा स्कैन', bn: 'বিপদ স্ক্যান', or: 'ବିପଦ ସ୍କାନ', ur: 'خطرہ اسکینز' },
  dash_scenarios: { en: 'Scenarios Run', hi: 'चलाए गए परिदृश्य', bn: 'চালানো পরিস্থিতি', or: 'ଚଲାଯାଇଥିବା ପରିସ୍ଥିତି', ur: 'چلائے گئے منظرنامے' },
  dash_avg: { en: 'Avg Scenario Score', hi: 'औसत परिदृश्य स्कोर', bn: 'গড় পরিস্থিতি স্কোর', or: 'ହାରାହାରି ପରିସ୍ଥିତି ସ୍କୋର', ur: 'اوسط منظرنامہ اسکور' },
  dash_log: { en: 'Activity Log', hi: 'गतिविधि लॉग', bn: 'কার্যকলাপ লগ', or: 'କାର୍ଯ୍ୟକଳାପ ଲଗ', ur: 'سرگرمی لاگ' },
  ...
  dash_hazards_word: { en: 'hazards', hi: 'खतरे', bn: 'বিপদ', or: 'ବିପଦ', ur: 'خطرات' },
  ...
  chat_title: { en: 'KHATRA Assistant', hi: 'खतरा सहायक', bn: 'খতরা সহায়ক', or: 'KHATRA ସହାୟକ', ur: 'کھترا اسسٹنٹ' },
  ...
  chat_greeting: {
    en: "Hi! I'm the KHATRA assistant. Ask me anything about how this app works — hazard scanning, scenarios, settings, or anything you're unsure about.",
    hi: 'नमस्ते! मैं खतरा सहायक हूं। यह ऐप कैसे काम करता है — खतरा स्कैनिंग, परिदृश्य, सेटिंग्स, या जो भी आपको समझ न आए, मुझसे कुछ भी पूछें।',
    bn: 'নমস্কার! আমি খতরা সহায়ক। এই অ্যাপ কীভাবে কাজ করে — বিপদ স্ক্যানিং, পরিস্থিতি, সেটিংস, বা যা কিছু নিয়ে আপনি নিশ্চিত নন, আমাকে জিজ্ঞাসা করুন।',
    or: 'ନମସ୍କାର! ମୁଁ KHATRA ସହାୟକ। ଏହି ଆପ କିପରି କାର୍ଯ୍ୟ କରେ — ବିପଦ ସ୍କାନିଂ, ପରିସ୍ଥିତି, ସେଟିଂସ, କିମ୍ବା ଆପଣ ନିଶ୍ଚିତ ନଥିବା ଯେକୌଣସି ବିଷୟରେ ମୋତେ ପଚାରନ୍ତୁ।',
    ur: 'السلام علیکم! میں کھترا اسسٹنٹ ہوں۔ یہ ایپ کیسے کام کرتی ہے — خطرہ اسکیننگ، منظرنامے، ترتیبات، یا جو کچھ بھی آپ کو سمجھ نہ آئے، مجھ سے پوچھیں۔',
  },
  chat_no_key: {
  ...
  cert_name_label: { en: 'Worker Name', hi: 'श्रमिक का नाम', bn: 'শ্রমিকের নাম', or: 'ଶ୍ରମିକ ନାମ', ur: 'ورکر کا نام' },
  cert_name_placeholder: { en: 'Enter your full name', hi: 'अपना पूरा नाम दर्ज करें', bn: 'আপনার পূর্ণ নাম লিখুন', or: 'ଆପଣଙ୍କ ପୂର୍ଣ୍ଣ ନାମ ଲେଖନ୍ତୁ', ur: 'اپنا پورا نام درج کریں' },
  ...
  cert_avg_score: { en: 'Average Score', hi: 'औसत स्कोर', bn: 'গড় স্কোর', or: 'ହାରାହାରି ସ୍କୋର', ur: 'اوسط اسکور' },
  cert_qr_hint: { en: 'Scan this QR code to verify this certificate online.', hi: 'इस प्रमाणपत्र को ऑनलाइन सत्यापित करने के लिए यह क्यूआर कोड स्कैन करें।', bn: 'এই সনদটি অনলাইনে যাচাই করতে এই কিউআর কোডটি স্ক্যান করুন।', or: 'ଏହି ପ୍ରମାଣପତ୍ରକୁ ଅନଲାଇନରେ ଯାଞ୍ଚ କରିବାକୁ ଏହି QR କୋଡ ସ୍କାନ କରନ୍ତୁ।', ur: 'اس سرٹیفکیٹ کو آن لائن تصدیق کرنے کے لیے یہ کیو آر کوڈ اسکین کریں۔' },
  ...
  verify_title: { en: 'KHATRA Certificate Check', hi: 'खतरा प्रमाणपत्र जांच', bn: 'খতরা সনদ যাচাই', or: 'KHATRA ପ୍ରମାଣପତ୍ର ଯାଞ୍ଚ', ur: 'کھترا سرٹیفکیٹ چیک' },
  verify_valid: { en: 'Valid Certificate', hi: 'वैध प्रमाणपत्र', bn: 'বৈধ সনদ', or: 'ବୈଧ ପ୍ରମାଣପତ୍ର', ur: 'درست سرٹیفکیٹ' },
  verify_issued: { en: 'Issued', hi: 'जारी किया गया', bn: 'ইস্যু করা হয়েছে', or: 'ଜାରି ହୋଇଛି', ur: 'جاری کیا گیا' },
  verify_avg: { en: 'Overall Average', hi: 'कुल औसत', bn: 'সামগ্রিক গড়', or: 'ସାମଗ୍ରିକ ହାରାହାରି', ur: 'مجموعی اوسط' },
  ...
  admin_demo_notice: {
    en: 'Demo mode: showing certification data stored on this device only. A production deployment would sync this across all worker devices via a backend (e.g. Firebase/Supabase).',
    hi: 'डेमो मोड: केवल इस डिवाइस पर संग्रहीत प्रमाणन डेटा दिखा रहा है। उत्पादन परिनियोजन इसे बैकएंड (जैसे Firebase/Supabase) के माध्यम से सभी श्रमिक उपकरणों में सिंक करेगा।',
    bn: 'ডেমো মোড: শুধুমাত্র এই ডিভাইসে সংরক্ষিত সনদ ডেটা দেখাচ্ছে। প্রোডাকশন সংস্করণ ব্যাকএন্ডের (যেমন Firebase/Supabase) মাধ্যমে সমস্ত শ্রমিক ডিভাইসে এটি সিঙ্ক করবে।',
    or: 'ଡେମୋ ମୋଡ: କେବଳ ଏହି ଡିଭାଇସରେ ସଂରକ୍ଷିତ ପ୍ରମାଣନ ତଥ୍ୟ ଦେଖାଉଛି। ଉତ୍ପାଦନ ସଂସ୍କରଣ ଏକ ବ୍ୟାକଏଣ୍ଡ (ଯେପରି Firebase/Supabase) ମାଧ୍ୟମରେ ସମସ୍ତ ଶ୍ରମିକ ଡିଭାଇସରେ ଏହାକୁ ସିଙ୍କ କରିବ।',
    ur: 'ڈیمو موڈ: صرف اس ڈیوائس پر محفوظ سرٹیفیکیشن ڈیٹا دکھا رہا ہے۔ پروڈکشن ورژن اسے بیک اینڈ (جیسے Firebase/Supabase) کے ذریعے تمام ورکر ڈیوائسز پر سنک کرے گا۔',
  },
  admin_total_certs: { en: 'Certificates Issued', hi: 'जारी प्रमाणपत्र', bn: 'ইস্যুকৃত সনদ', or: 'ଜାରି ପ୍ରମାଣପତ୍ର', ur: 'جاری سرٹیفکیٹس' },
  admin_avg_compliance: { en: 'Avg Compliance', hi: 'औसत अनुपालन', bn: 'গড় কমপ্লায়েন্স', or: 'ହାରାହାରି ଅନୁପାଳନ', ur: 'اوسط تعمیل' },
  admin_domains: { en: 'Safety Domains', hi: 'सुरक्षा डोमेन', bn: 'নিরাপত্তা ডোমেইন', or: 'ସୁରକ୍ଷା ଡୋମେନ', ur: 'حفاظتی ڈومینز' },
  admin_pass_rate: { en: 'Cert Pass Rate', hi: 'प्रमाणन पास दर', bn: 'সনদ পাস হার', or: 'ପ୍ରମାଣନ ପାସ ହାର', ur: 'سرٹیفکیٹ پاس ریٹ' },
  ...
  admin_records: { en: 'records', hi: 'रिकॉर्ड', bn: 'রেকর্ড', or: 'ରେକର୍ଡ', ur: 'ریکارڈز' },
  ...
  // --- Santali notice banner (shown when sat selected, for content not yet natively reviewed) ---
  sat_notice: {
    en: '', hi: '', bn: '', or: '', ur: '',
    sat: 'ᱥᱟᱱᱛᱟᱲᱤ ᱨᱮᱭᱟᱜ ᱛᱚᱨᱡᱚᱢᱟ ᱵᱟᱝ ᱯᱩᱨᱟᱹ ᱠᱟᱱᱟ — ᱤᱧᱡᱤᱱᱤᱭᱟᱹᱨᱤᱭᱟᱜ ᱛᱚᱨᱡᱚᱢᱟ ᱟᱨ ᱥᱟᱶᱛᱮ ᱟᱭᱢᱟ ᱛᱚᱸᱜᱚᱴ ᱠᱟᱱᱟ, ᱱᱮᱛᱟᱜ ᱟᱠᱟᱱ ᱤᱧᱜᱞᱤᱥ ᱫᱮᱠᱷᱟᱣ ᱠᱟᱱᱟ ᱾',
  },
}
